...
public final class Schema implements Iterable<ColumnReference> {
     ...
     * statistics.
     *
     * @param columns       list of column references
     * @param tables        list of base table references
     * @param candidateKeys candidate keys of the described collection of tuples
     * @param foreignKeys   foreign keys of the described collection of tuples
     */
     ...
     *
     * @param name       the name of the field
     * @param tableAlias the table alias of the field
     * @return the number of the field or {@code -1}, if not found
     * @deprecated Use {@link Schema#getColumn(int)} instead.
     */
    @Deprecated
     ...
     *
     * @param tuple   tuple contents
     * @param fieldNo the number of the given field
     ...
     *
     * @param tuple tuple contents
     * @param salt  salt to create different hashes
     * @return hash
     */
     ...
     *
     * @param left  left columns
     * @param right right columns
